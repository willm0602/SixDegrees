...
<div class="flex mx-auto mt-12">
    <button class="btn h-10 self-center variant-filled-surface" on:click={()=>{$moveLeft()}}>
    ...
    <button class="btn variant-filled-surface h-10 self-center" on:click={()=>{$moveRight()}}><iconify-icon icon="octicon:arrow-right-16" class="text-4xl" /></button>
</div>
